...
export const sendRes = (res, resObj) => {
    const { statusCode, data } = resObj;
    res.status(statusCode).json(data);
};
export const getPayloadFromGoogle = async (token) => {
 ...
 */
export const checkIfMail = (emailOrUsername) => {
 ...
 */
export const validateString = (str, { minLength = 1, maxLength = 300, allowSpecialChars = true, allowNumbers = true, disallowedPattern, stringName = "provided string", } = {}) => {
 ...
 */
export const validateNumber = (value, { min, max, allowFloat = true, allowZero = false, valueName = "Provided number", } = {}) => {
...
//# sourceMappingURL=reusableFunc.js.map