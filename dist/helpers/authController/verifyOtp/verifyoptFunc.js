import { verifyotpIfInvalid, verifyotpIfExpire, ifCouldnotSetPwd, } from "./errObj.js";
import { AirClipErr } from "../../../utils/error/AirClipErr.js";
import { OTP } from "../../../models/otp.model.js";
import { User } from "../../../models/user.model.js";
export const chkOtp = async (otp, userEmail) => {
    ...
    if (otpRecord) {
        ...
        throw new AirClipErr(verifyotpIfExpire);
};
export const updateUser = async (selectedUser, hashedPassword) => {
